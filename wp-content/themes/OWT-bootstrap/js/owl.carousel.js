	...
	$('#un-carousel .thumbnails .thumb-link').click(function(){
      ...
      $('#un-carousel .next').click(function(){
        if (document.documentElement.clientWidth < 1200) {
            $('#un-carousel .thumbnails').animate({top: '-476px'},function(){
